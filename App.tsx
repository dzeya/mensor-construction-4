...
const Navbar = () => {
  return (
    <nav className="fixed top-0 left-0 right-0 z-40 flex justify-between items-center px-8 py-6 glass-panel border-t-0 border-l-0 border-r-0 border-b border-white/5 transition-all duration-300">
      <div className="flex items-center group cursor-pointer">
        <div className="h-16 transition-transform duration-300 hover:scale-105">
      ...
      <button className="hidden md:flex items-center gap-2 border border-mensor-accent/50 text-mensor-accent px-6 py-2.5 text-xs font-mono font-bold tracking-widest hover:bg-mensor-accent hover:text-white transition-all group">
        РАССЧИТАТЬ
...
const SectionTitle = ({ title, subtitle }: { title: string, subtitle: string }) => {
  ...
  return (
    <div ref={ref} className="mb-20 text-center opacity-0">
...
function App() {
  ...
  return (
    <div className="min-h-screen relative overflow-x-hidden selection:bg-mensor-accent selection:text-white bg-mensor-dark">
      ...
      <section className="relative h-screen w-full flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 container mx-auto px-8 mt-20">
          <div ref={heroTextRef} className="max-w-5xl">
            ...
            <h1 className="hero-element text-4xl md:text-6xl lg:text-7xl font-bold text-white opacity-0 leading-none mb-6">
              ГЕОДЕЗИЯ,<br />
              3D-СКАНИРОВАНИЕ<br />
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-mensor-accent to-white">И КОНТРОЛЬ СТРОИТЕЛЬСТВА</span>
            </h1>

            <p className="hero-element text-lg md:text-xl text-mensor-light/80 font-light mt-6 max-w-2xl opacity-0 leading-relaxed border-l-4 border-mensor-accent pl-6 mb-10">
              Точность 1 мм. Ускоряем изыскания и исключаем ошибки в проекте. Экономим до 15% бюджета, избавляя вас от брака и переделок.
            </p>

            <div className="hero-element opacity-0 flex flex-col sm:flex-row gap-6 mb-12">
              <button className="bg-mensor-accent text-white px-8 py-4 font-mono text-sm font-bold tracking-widest hover:bg-white hover:text-mensor-dark transition-all duration-300 flex items-center justify-center gap-4 group">
                РАССЧИТАТЬ СТОИМОСТЬ
                <ArrowRight className="group-hover:translate-x-2 transition-transform" size={18} />
              </button>
              <button className="bg-transparent border border-white/20 text-white px-8 py-4 font-mono text-sm font-bold tracking-widest hover:bg-white/10 transition-all duration-300">
                ВСЕ УСЛУГИ
              </button>
            </div>

            <div className="hero-element opacity-0 flex flex-wrap gap-x-8 gap-y-3 text-xs font-mono text-mensor-light/60 uppercase tracking-wider">
      ...
      {/* BLOCK 2: ADVANTAGES */}
      <section className="py-24 bg-mensor-dark relative z-10">
      ...
      <section id="solutions" className="py-24 bg-mensor-dark border-t border-white/5">
        <div className="container mx-auto px-6">
      ...
      <section className="py-24 bg-mensor-gray border-y border-white/5">
         <div className="container mx-auto px-6">
      ...
      {/* BLOCK 7: BLOG */}
      <section id="blog" className="py-24 bg-mensor-dark">
        <div className="container mx-auto px-6">
